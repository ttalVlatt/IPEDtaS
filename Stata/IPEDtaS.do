...
## Broken Line
do_fix("f2223_f3.do", 100, 'label variable xf3c12 "Imputation field for f3c12 - Total discounts and allowances from Pell grants"')
do_fix("f2223_f3.do", 101, '')
do_fix("f2223_f3.do", 102, '')
do_fix("f2223_f3.do", 103, 'label variable f3c12    "Total discounts and allowances from Pell grants"')
do_fix("f2223_f3.do", 104, '')
do_fix("f2223_f3.do", 105, '')
do_fix("f2223_f3.do", 124, 'label variable xf3c151 "Imputation field for f3c151 - Discounts and  allowances from local government grants applied to tuition and fees"')
do_fix("f2223_f3.do", 125, '')
do_fix("f2223_f3.do", 126, 'label variable f3c151   "Discounts and allowances from local government grants applied to tuition and fees"')
do_fix("f2223_f3.do", 127, '')
do_fix("f2223_f3.do", 130, 'label variable xf3c16 "Imputation field for f3c16 - Total discounts and allowances from endowments and gifts"')
do_fix("f2223_f3.do", 131, '')
do_fix("f2223_f3.do", 132, 'label variable f3c16    "Total discounts and allowances from endowments and gifts"')
do_fix("f2223_f3.do", 133, '')
do_fix("f2223_f3.do", 134, 'label variable xf3c161 "Imputation field for f3c161 - Discounts and allowances from endowments and gifts applied to tuition and fees"')
do_fix("f2223_f3.do", 135, '')
do_fix("f2223_f3.do", 136, 'label variable f3c161   "Discounts and allowances from endowments and gifts applied to tuition and fees"')
do_fix("f2223_f3.do", 137, '')
do_fix("f2223_f3.do", 142, 'label variable xf3c171 "Imputation field for f3c171 - Discounts and allowances from other institutional sources applied to tuition and fees"')
do_fix("f2223_f3.do", 143, '')
do_fix("f2223_f3.do", 144, 'label variable f3c171   "Discounts and allowances from other institutional sources applied to tuition and fees"')
do_fix("f2223_f3.do", 145, '')

## Broken Line
do_fix("f2223_f2.do", 102, 'label variable xf2c12 "Imputation field for f2c12 - Total discounts and allowances from Pell grants"')
do_fix("f2223_f2.do", 103, '')
do_fix("f2223_f2.do", 104, 'label variable f2c12    "Total discounts and allowances from Pell grants"')
do_fix("f2223_f2.do", 105, '')
do_fix("f2223_f2.do", 106, 'label variable xf2c121 "Imputation field for f2c121 - Discounts and allowances from Pell grants applied to tuition and fees"')
do_fix("f2223_f2.do", 107, '')
do_fix("f2223_f2.do", 108, 'label variable f2c121   "Discounts and allowances from Pell grants applied to tuition and fees"')
do_fix("f2223_f2.do", 109, '')
do_fix("f2223_f2.do", 116, 'label variable xf2c132 "Imputation field for f2c132 - Discounts and allowances from other federal grants applied to auxiliary enterprises"')
do_fix("f2223_f2.do", 117, '')
do_fix("f2223_f2.do", 118, 'label variable f2c132   "Discounts and allowances from other federal grants applied to auxiliary enterprises"')
do_fix("f2223_f2.do", 119, '')
do_fix("f2223_f2.do", 120, 'label variable xf2c14 "Imputation field for f2c14 - Total discounts and allowances from state government grants"')
do_fix("f2223_f2.do", 121, '')
do_fix("f2223_f2.do", 122, 'label variable f2c14    "Total discounts and allowances from state government grants"')
do_fix("f2223_f2.do", 123, '')
do_fix("f2223_f2.do", 124, 'label variable xf2c141 "Imputation field for f2c141 - Discounts and allowances from state government grants applied to tuition and fees"')
do_fix("f2223_f2.do", 125, '')
do_fix("f2223_f2.do", 126, 'label variable f2c141   "Discounts and allowances from state government grants applied to tuition and fees"')
do_fix("f2223_f2.do", 127, '')

# Broken Lines
do_fix("f2223_f1a.do", 254, 'label variable xf1e12 "Imputation field for f1e12 - Total discounts and allowances from Pell grants"')
do_fix("f2223_f1a.do", 255, '')
do_fix("f2223_f1a.do", 256, '')
do_fix("f2223_f1a.do", 257, 'label variable f1e12    "Total discounts and allowances from Pell grants"')
do_fix("f2223_f1a.do", 258, '')
do_fix("f2223_f1a.do", 259, '')
do_fix("f2223_f1a.do", 260, 'label variable xf1e121 "Imputation field for f1e121 - Discounts and allowances from Pell grants applied to tuition and fees"')
do_fix("f2223_f1a.do", 261, '')
do_fix("f2223_f1a.do", 262, 'label variable f1e121   "Discounts and allowances from Pell grants applied to tuition and fees"')
do_fix("f2223_f1a.do", 263, '')
do_fix("f2223_f1a.do", 282, 'label variable xf1e152 "Imputation field for f1e152 - Discounts and allowances from local government grants applied to auxiliary enterprises"')
do_fix("f2223_f1a.do", 283, '')
do_fix("f2223_f1a.do", 284, 'label variable f1e152   "Discounts and allowances from local government grants applied to auxiliary enterprises"')
do_fix("f2223_f1a.do", 285, '')
do_fix("f2223_f1a.do", 292, 'label variable xf1e17 "Imputation field for f1e17 - Total discounts and allowances from other institutional sources"')
do_fix("f2223_f1a.do", 293, '')
do_fix("f2223_f1a.do", 294, 'label variable f1e17    "Total discounts and allowances from other institutional sources"')
do_fix("f2223_f1a.do", 295, '')
do_fix("f2223_f1a.do", 296, 'label variable xf1e171 "Imputation field for f1e171 - Discounts and allowances from other institutional sources applied to tuition and fees"')
do_fix("f2223_f1a.do", 297, '')
do_fix("f2223_f1a.do", 298, 'label variable f1e171   "Discounts and allowances from other institutional sources applied to tuition and fees"')
do_fix("f2223_f1a.do", 299, '')


# All variable names wrong (appears to be 1234 vs 2468, but unclear, comment all out for now)
do_fix("drvom2023.do", 32, '/* */')

# Variable name from
do_fix("ef2023a.do", 96, '/* */')
do_fix("ef2023a.do", 98, '/* */')
do_fix("ef2023a.do", 100, '/* */')
do_fix("ef2023a.do", 102, '/* */')
